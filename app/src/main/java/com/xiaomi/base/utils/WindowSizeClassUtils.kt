...
object WindowSizeClassUtils {
    ...
    fun getResponsivePadding(windowSizeClass: WindowSizeClass): ResponsivePadding {
        return when (windowSizeClass.widthSizeClass) {
            WindowWidthSizeClass.Compact -> ResponsivePadding(
                horizontal = 16.dp,
                vertical = 8.dp,
                content = 12.dp
            )
            WindowWidthSizeClass.Medium -> ResponsivePadding(
                horizontal = 24.dp,
                vertical = 16.dp,
                content = 16.dp
            )
            WindowWidthSizeClass.Expanded -> ResponsivePadding(
                horizontal = 32.dp,
                vertical = 24.dp,
                content = 20.dp
            )
    ...
    fun getContentType(windowSizeClass: WindowSizeClass): ContentType {
        return when (windowSizeClass.widthSizeClass) {
            ...
            WindowWidthSizeClass.Medium -> when (windowSizeClass.heightSizeClass) {
                WindowHeightSizeClass.Medium,
                WindowHeightSizeClass.Expanded -> ContentType.DUAL_PANE
    ...
    fun getImageSize(windowSizeClass: WindowSizeClass): ImageSize {
        return when (windowSizeClass.widthSizeClass) {
            WindowWidthSizeClass.Compact -> ImageSize(
                width = 120.dp,
                height = 180.dp
            )
            WindowWidthSizeClass.Medium -> ImageSize(
                width = 140.dp,
                height = 210.dp
            )
            WindowWidthSizeClass.Expanded -> ImageSize(
                width = 160.dp,
                height = 240.dp
            )
            else -> ImageSize(
