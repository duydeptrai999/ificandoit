...
class TemplateEngine {
    ...
    private fun loadTemplate(templatePath: String): String {
        return try {
            ...
            val inputStream: InputStream? =
                javaClass.classLoader?.getResourceAsStream("assets/$templatePath")
     ...
     */
    private fun replaceProjectPlaceholders(
        template: String,
        context: ProjectContext,
    ): String {
        return template
    ...
    private fun replaceComponentPlaceholders(
        ...
        val componentName =
            customizations["COMPONENT_NAME"] as? String
     ...
     */
    private fun processConditionalBlocks(
        template: String,
        customizations: Map<String, Any>,
    ): String {
     ...
     */
    private fun processUnlessBlocks(
        template: String,
        customizations: Map<String, Any>,
    ): String {
