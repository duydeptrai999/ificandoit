...
class TemplateCustomizer {
    ...
    fun generateCustomizations(
        ...
        return CustomizationResult(
            ...
            validationResults =
                validatedOptions.map { (key, value) ->
     ...
     */
    private fun validateOptionValue(
    ...
    private fun validateSingleOption(
        ...
        val option =
            component.customizationOptions.find { it.key == key }
